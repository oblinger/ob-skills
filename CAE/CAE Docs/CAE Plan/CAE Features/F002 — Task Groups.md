...
- **Q2 — Pause semantics for groups: pause new dispatch only, or include in-flight cancellation?** — parallel to F001 Q2 for the global pause; do groups inherit the same semantics or have their own?
