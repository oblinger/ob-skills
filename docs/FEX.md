---
description: "the example gallery — worked anchors + a per-facet map"
---

# FEX - Facet Examples
A small set of complete, realistic example anchors — reused to illustrate each facet.

| -[[FEX]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[OBSK]] → [FEX](hook://p/FEX)<br>: the example gallery — worked anchors + a per-facet map |
| --- | --- |
...
| *(other facets)* | *pending — added per facet* |
