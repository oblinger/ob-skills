---
description: "Skills — section landing / index for ob-skills' invocable runbooks"
---

# Skills
| -[[SKL]]-                       | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [SKL](hook://p/SKL)<br>: Skills — the `/`-invocable runbooks (the things you type `/` for)                                                                                                                                                                                                                                                          |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Repo                            | [[DAS\|ob-skills]] (root)                                                                                                                                                                                                                                                                                                                                                                                   |
