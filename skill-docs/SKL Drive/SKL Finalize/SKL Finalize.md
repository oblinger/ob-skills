...
| -[[SKL Finalize]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [[SKL Drive]] → [SKL Finalize](hook://p/SKL%20Finalize)<br>: the `/finalize` skill |
| --- | --- |
| Related | [[skills/finalize/SKILL.md\|SKILL]],   |
| [[SKL Finalize Design\|Design]] |  |
