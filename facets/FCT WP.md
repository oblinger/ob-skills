...
- **NOT for**: project-wide markdown / linking rules ([[R-markdown]] and CLAUDE.md), Brief-discipline rules ([[CAB Brief]]), or anchor-local maintenance content (lives in `{NAME} Rules.md` / `{NAME} Decisions.md`).
