...
| -[[CAB Facets]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[CAB]] → [CAB Facets](hook://p/CAB%20Facets)<br>:  |
| --- | --- |
...
| ... | [[CAB Facets/Backlog]],  [[CAB Brief]],  [[CAB Completed Roadmap]],  [[CAB Facets/CAB Decisions]],  [[CAB Design Dispatch]],  [[CAB Facets/CAB Design]],  [[CAB Discussion]],  [[CAB Facets/CAB Log]],  [[CAB Facets/CAB Messages]],  [[CAB Naming]],  [[CAB Status]],  [[CAB Stories]],  [[CAB Testing]],  [[CAB Track Dispatch]],  [[Docs]],  [[Skill Anchor/skill-config]],  [[Skill Anchor/skill-script]],  [[Skill Anchor/skill-search-rules]],  [[Skill Anchor/skill-testing]],  [[TSK User Guide]],   |
