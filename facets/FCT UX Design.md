...
- **Rule set is co-located, not separate** — the `# RULESET R-ux` H1 at the bottom is part of this file per F133. When adding or revising rules, update the rule block in place; do not split it into a sibling file or duplicate it in [[FCT Rule Set]].
