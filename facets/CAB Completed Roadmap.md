...
- [[CAB Roadmap]] — parent facet; the forward-looking roadmap is the migration source
- [[CAB Features]] — feature docs; the M-position is encoded in their titles per R-roadmap-10
- [[CAB Design]] — Completed Roadmap is an OPTIONAL child of {NAME} Design/; activated when the first milestone migrates
...
- **The inclusion test for a new rule:** it constrains the *structure* of the completed-roadmap doc (location, order, preservation, naming) — not the forward-looking Roadmap (that's [[CAB Roadmap]]) and not feature-doc shape (that's [[CAB Features]]).
...
- **Cross-reference integrity is load-bearing:** the See also links to [[CAB Roadmap]], [[CAB Features]], [[CAB Design]], and F144/F145 wire this facet into the larger CAB graph — don't drop them when refactoring.
