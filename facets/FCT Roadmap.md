...
Each milestone is a group of feature docs (from [[FCT Features]]) that ship together. Milestone body lists the F-numbered features as wiki-links, plus an acceptance summary.
