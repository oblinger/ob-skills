...
- **Doc-sync is one-way, vault → repo.** Any edit to this spec that softens that invariant or adds a reverse path is load-bearing — flag it explicitly and update [[CAB Facets]] / related facet specs in the same pass.
