...
- **Sibling facets** ([[CAB WP]], [[CAB Backlog]], [[CAB Stat]]) cite this spec — when changing terminology or structure, search for back-cites and update them in the same pass.
