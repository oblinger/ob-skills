...
| **User** | `[[{NAME} User/{NAME} User\|User]]` | User Guide, Cards | [[CAB API Doc]], [[CAB Cards]] |
...
| **User** | `[[{NAME} User/{NAME} User\|User]]` | Interface (required for code), Guide, Architecture, Cards | [[CAB User Dispatch]], [[CAB Interface]], [[CAB Cards]] |
| **Dev** | `[[{NAME} Dev/{NAME} Dev\|Dev]]` | Files, per-module docs | [[CAB Files]], [[CAB API Doc]] |
