...
- **Sibling boundaries:** PRD belongs in [[CAB PRD]]; cross-cutting decisions and their rationale belong in [[CAB Decisions]] / [[CAB Discussion]]; user-facing UX belongs in [[CAB UX Design]]. Link sideways instead of restating their content here.
