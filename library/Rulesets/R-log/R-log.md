...
Catalog-side stub for the Log facet rule set. Canonical body lives embedded inside [[FCT Log]] per the [[F133 — Rule sets folder convention + facet embedding|F133]] convention.
