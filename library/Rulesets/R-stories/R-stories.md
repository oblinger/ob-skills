...
Catalog-side stub for the Stories facet rule set. Canonical body lives embedded inside [[FCT Stories]] per the [[F133 — Rule sets folder convention + facet embedding|F133]] convention.
...
- [[R-testing]], [[R-status]], [[R-log]] — sibling materialized facet rule sets.
