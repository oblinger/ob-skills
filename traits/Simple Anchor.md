...
- **Cross-references to keep aligned** — [[CAB Base]] (parent), [[CAB Traits]] (dispatch), `/audit structure`, `/create anchor`, `/migrate`. Renaming this trait or its deltas requires sweeping those surfaces; don't rename in isolation.
