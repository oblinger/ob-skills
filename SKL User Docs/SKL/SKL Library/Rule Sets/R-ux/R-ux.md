# RULESET R-ux
include:: [[CAB UX Design#RULESET R-ux|embedded body]]
description:: Catalog stub — rules for `{NAME} UX Design.md`, the *human* user-facing surface intent. Canonical body lives embedded in [[CAB UX Design]].

Catalog-side stub for the UX Design facet's rule set. The canonical body lives embedded inside the [[CAB UX Design]] facet file per the [[F133 — Rule sets folder convention + facet embedding|F133]] convention.

**To see the actual rules:** follow [[CAB UX Design#RULESET R-ux|the embedded block]]. 8 rules covering:
...
- [[CAB UX Design]] — facet spec; contains the embedded RULESET body.
