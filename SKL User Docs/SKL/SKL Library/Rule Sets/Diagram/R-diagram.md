...
description:: Authoring + validation rules for hand-authored figures (architecture, flow, sequence, mockups). PCB-DRC-style discipline: diagram doesn't ship until rule-checker emits zero errors. Twenty-two rules from the 2026-06-08 diagram-auditing methodologies survey.
