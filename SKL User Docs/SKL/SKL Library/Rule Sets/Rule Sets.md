...
| --- | |
| [[R-discussion]] | Catalog stub — rules for `# Discussion` (inline) or `{Doc} Discussions.md` (extracted), the first *document-scoped* facet. Canonical body lives embedded in [[CAB Discussion]]. |
| [[Rule Sets/README]] |  |
