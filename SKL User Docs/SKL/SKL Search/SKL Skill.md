...
`find` and `describe` are uncommon for skills — when relevant, fall back to the verb defaults; user overrides land in `SRC rules/find-skill.md` / `SRC rules/describe-skill.md` as patterns emerge.
