...
| -[[Clarifier]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [Clarifier](hook://p/Clarifier)<br>: example project anchor — a designed software project |
| --- | --- |
| Related | [[Snap]] (example skill),  [[FCT Project Page]] (the facet),  [[FEX]] (the example gallery) |
