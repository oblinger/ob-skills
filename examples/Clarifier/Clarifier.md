...
| -[[Clarifier]]- | → [[KM]] → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [Clarifier](hook://p/Clarifier)<br>: example project anchor — a designed software project |
| --- | --- |
| Related | ~~[[Snapper Dapper]]~~ (example skill),  [[FCT Project Page]] (the facet),  [[FEX]] (the example gallery) |
