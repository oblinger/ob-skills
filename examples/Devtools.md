...
| -[[Devtools]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [Devtools](hook://p/Devtools)<br>: example grouped-dispatch collection (> 15 members) |
| --- | --- |
| Related | [[Bridges]] (flat variant),  [[CAB Dispatch Table]],  [[DSC progressive-disclosure]],  [[FEX]], |
