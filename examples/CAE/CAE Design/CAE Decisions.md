...
The H2 sections above (Principles, Rules) carry D01–D10 from the F113 unification. Going forward, this H2 holds true anchor-specific *decisions* — applied choices with rationale that cite rules from [[CAE Rules]]'s adopted sets. (Future migration may re-split D04–D10 into anchor-local rules under [[CAE Rules]]; deferred.)
