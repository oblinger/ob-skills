...
- [ ] `module_docs_audited:` frontmatter on `{NAME} Dev.md` is owned by this skill — no other skill writes it (per F074, [[CAB Module Doc]] § `{NAME} Dev.md` frontmatter).
