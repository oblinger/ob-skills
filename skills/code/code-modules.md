...
**MANDATORY: Before writing any module doc, read the [[FCT API Doc]] reference example in full.** The reference example IS the spec — match it exactly. Do not improvise the format from memory.
