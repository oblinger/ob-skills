...
3. **Never auto-push** — the agent commits freely but does NOT push to remotes unless the user explicitly says so. Auto-push is the irreversible action that the [[F068]] gate protects against; auto-commit is fully reversible (rewrite history locally).
