...
---
# describe-product — default rules

Default rules for `describe` on noun-type **product**. Ships with the skill; user overrides in `[[SRC rules/describe-product|SRC rules/]]`.
...
(Empty — user adds in `SRC rules/describe-product.md` to override these defaults.)
