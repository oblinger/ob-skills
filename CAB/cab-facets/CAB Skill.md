...
4. **Dispatch table** — Wiki-link table mirroring the anchor's slug page format. Groups reference data by section (e.g., Types, Parts, Rules). Every entry is a clickable wiki-link. Only present when the skill manages reference data.
