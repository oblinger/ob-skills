...
**⚠️ NON-NEGOTIABLE: The very first thing under the `# {NAME} CLI` H1 — no exceptions, no intro paragraph, no Synopsis section, no description — is a fenced code block. Full stop.**
