...
RULES = {
    ...
    "script-assisted": [
        ...
        "where:: `**/*.md`",
        "```",
        "# hand the oracle one question + just this slice; it returns a list",
        "resolved = ask_oracle('which of these are already answered elsewhere?',",
        "                      file.section('## Open Questions'))",
        "for question in resolved:",
        "    tell(f'{question} looks resolved — close it or move to Resolved')",
        "```",
    ],
    "edit": [
